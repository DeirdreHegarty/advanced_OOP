...
class GameController{
    ...
    static void setState(String gameStateName){
		...
		//Exit the WinState or LooseState and change to CrapState
		if(gameStateName.equals("WIN")||gameStateName.equals("LOOSE")) 
			setState("CRAPS");
    }
	static void setState(String gameStateName, int rollValue){
        CrapsGameState changeState = getState(gameStateName);
...
class WinState extends CrapsGameState{
	...
	void doExitActivity(){ 
		...
		//GameController.setState("CRAPS"); Remove this line
    }
}
