...
public class ClassicFiddle extends PlainFiddle{ // 02 made public (access from outside package)
	public void playSweetly(){					// 03 made public (access from outside package)
