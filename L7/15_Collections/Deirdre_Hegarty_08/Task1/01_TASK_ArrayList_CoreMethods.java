...
// ii)  
	    ...
	    ListIterator i = moreFruit.listIterator();
	    while(i.hasNext()){
	    	if(i.next().equals("apple")){
	    		int num = i.nextIndex() - 1;
		    	indexList.add(num);	
		    }
	    }
	    // System.out.println(indexList); 
	    int findSecondApple = indexList.get(1); // get the second instance of "apple" from new list
